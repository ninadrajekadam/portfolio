			...
			<div className="heading-btn-wrapper">
				<div className="heading-wrapper">
					...
					<div className="heading">
						<h2 className="layout-heading">Certifications</h2>
					</div>
				</div>
				<Button className="btn-primary-custom add-btn" onClick={handleShow}><FontAwesomeIcon icon={faPlus} /> Add Certification</Button>
			</div>
			<div className="table-wrapper">
				<Search placeholder="Search Certificate..." />
